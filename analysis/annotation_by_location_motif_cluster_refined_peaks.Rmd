---
title: "Annotating footprints using motif cluster, using refined peaks"
author: "XSun"
date: "2026-03-12"
output:
...
base_out_dir  <- "/project/spott/xsun/fiberseq/2.annotating_footprints/results/annotate_fp_motif/motif_annotation/refined_peaks/"
```
...
motif_fp_counts <- readRDS(paste0(base_out_dir, "/30-60bp/motif_footprint_counts.RDS"))
...
motif_fp_counts <- readRDS(paste0(base_out_dir, "/60-80bp/motif_footprint_counts.RDS"))
