...
res <- res[,-c("hex","total_bp_state","fire_overlap_bp","frac_of_fire_bp_in_state")]
res <- res[,c("state_id","description","total_state_Mb","fire_overlap_Mb","frac_state_covered_by_fire")]
res$frac_state_covered_by_fire <- res$frac_state_covered_by_fire*100
colnames(res)[5] <- "%state_covered_by_fire"


DT::datatable(res,caption = htmltools::tags$caption( style = 'caption-side: left; text-align: left; color:black;  font-size:150% ;','FIRE Coverage for 15 states from ChromHMM'),options = list(pageLength = 20) )
