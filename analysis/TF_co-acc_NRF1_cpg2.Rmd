...
<figure class="half">
    <img src="https://github.com/xsun1229/fiberseq/raw/master/output/MA0506.1.png" width="150%">
</figure>
...
sites_selected <- sites_selected[sample(x = 1:length(sites_selected),size = 3,replace = F)]
...
for (site in sites_selected){
  ...
  cat("By combining the CpG position matrix with the methylation quality matrix, we annotate methylated sites as mC.")
